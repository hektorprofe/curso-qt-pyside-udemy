...
auto_py_to_exe              # sin intérprete
python -m auto_py_to_exe    # con intérprete
```
...
Copiamos la ruta a los `site-packages`, seleccionamos y clic derecho en la selección para copiar la ruta. Accedemos a ella haciendo clic derecho en la línea de comandos para pegar y siendo administradores abrimos el explorador en ese directorio:
